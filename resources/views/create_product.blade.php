<x-app-layout>
    ...
    @endif
    <form method="POST" action="{{ route('product.store') }}" class="w-1/2 bg-white rounded-md p-6 mt-6 m-auto"
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="title" :value="old('title')" />
